...
class FilterScreen extends HookWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final cuisines = [
      ...
      RecipeFilter(id: 44, name: 'Chinese'),
      RecipeFilter(id: 65, name: 'Japanese'),
      RecipeFilter(id: 14, name: 'Thai'),
      RecipeFilter(id: 68, name: 'Korean'),
      RecipeFilter(id: 42, name: 'French'),
      RecipeFilter(id: 49, name: 'Spanish'),
      RecipeFilter(id: 52, name: 'German'),
      RecipeFilter(id: 53, name: 'Turkish'),
      RecipeFilter(id: 48, name: 'Greek'),
      RecipeFilter(id: 32, name: 'Russian'),
      RecipeFilter(id: 51, name: 'English'),
      RecipeFilter(id: 59, name: 'Moroccan'),
      RecipeFilter(id: 71, name: 'Lebanese'),
      RecipeFilter(id: 74, name: 'Egyptian'),
      RecipeFilter(id: 70, name: 'Vietnamese'),
      RecipeFilter(id: 61, name: 'Cuban'),
    ];

    final dietaryRestrictions = [
      RecipeFilter(id: 12, name: 'Vegetarian'),
      RecipeFilter(id: 9, name: 'Vegan'),
      RecipeFilter(id: 1, name: 'Low-Calorie'),
      RecipeFilter(id: 11, name: 'Low-Carb'),
      RecipeFilter(id: 3, name: 'Low-Fat'),
      RecipeFilter(id: 4, name: 'Low-Sodium'),
      RecipeFilter(id: 85, name: 'Dairy-Free'),
      RecipeFilter(id: 6, name: 'Gluten-Free'),
      RecipeFilter(id: 28, name: 'Lactose-Free'),
      RecipeFilter(id: 75, name: 'Sugar-Free'),
      RecipeFilter(id: 90, name: 'Salt-Free'),
    ];
                  ...
                  children: [
                    ...
                    Wrap(
                      ...
                      children: cookingMethods
                          .map((filter) => FilterChip(
                                label: Text(filter.name),
                                selected: selectedCookingMethod.value?.id ==
                                    filter.id,
                                onSelected: (bool selected) {
